...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Huge TUSHAR BASAK \vspace{2pt}} & % row = 1, col = 1
  Location: Kanpur, U.P, India \\ % row = 1, col = 2
  \href{https://tushar0o7.github.io/website/index.html}{\uline{Website}} $|$ % row = 2, col = 1
  \href{https://www.linkedin.com/in/tushar0o7}{\uline{LinkedIn}} $|$ % row = 2, col = 1
  \href{https://github.com/Tushar0o7}{\uline{GitHub}} $|$ % row = 2, col = 1
  \href{https://leetcode.com/Tushar0o7/}{\uline{Leetcode}} & % row = 2, col = 1
  Email: \href{mailto:tushar.basak@yahoo.com}{\uline{tushar.basak@yahoo.com}} $|$ % row = 2, col = 2
  Mobile: 8299312126 \\ % row = 2, col = 2
\end{tabular*}
%--------------------------------------------
